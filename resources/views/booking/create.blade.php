            ...
            <form method="POST" action="{{ route('bookings.store') }}" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            <label for="referred_by" class="block text-sm font-medium text-gray-700 mb-1">Referred By
                        ...
                        <div>
                            <label for="project_id3" class="block text-sm font-medium text-gray-700 mb-1">Select
                                Project</label>
                        ...
                        <input type="hidden" name="unit_name" id="unit_name" value="{{ old('unit_name') }}">

                        {{-- Selected Unit Display (Read-only visual feedback) --}}
                        <div id="selected-unit-display" class="bg-blue-50 border border-blue-200 rounded-lg p-4"
                            style="display: none;">
                    ...
                    <div class="space-y-6">
                        ...
                        <input type="hidden" name="unit_size" id="unit_size_input" value="{{ old('unit_size') }}">
                        <input type="hidden" name="unit_unit" id="unit_unit_select"
                            value="{{ old('unit_unit', 'Sq. Feet') }}">

                        <div>
                            <label for="booking_date" class="block text-sm font-medium text-gray-700 mb-1">Booking
                                Date</label>
                        ...
                        <div>
                            <label for="followup_date" class="block text-sm font-medium text-gray-700 mb-1">Follow-up
                                Date</label>
