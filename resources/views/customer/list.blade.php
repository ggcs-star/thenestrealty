            ...
            <div class="mb-8">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <a href="{{ route('customers.create') }}"
                        class="inline-flex items-center justify-center gap-2 bg-[#AC7E2C] text-white px-4 py-2 rounded-lg hover:bg-[#8C651F] transition-colors shadow-sm">
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-green-600 mt-1">
                                {{ $customers->where('status', 'active')->count() }}</p>
                        </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-purple-600 mt-1">
                                {{ $customers->whereNotNull('referred_by')->count() }}</p>
                        </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-orange-600 mt-1">
                                {{ $customers->whereBetween('created_at', [now()->startOfMonth(), now()->endOfMonth()])->count() }}
                            </p>
                        </div>
                    ...
                    <form method="GET" class="flex flex-col sm:flex-row gap-3">
                        ...
                        <div class="w-full sm:w-48">
                            <select name="referred_by"
                                ...
                                <option value="online" {{ request('referred_by') == 'online' ? 'selected' : '' }}>Online
                                </option>
                                <option value="walk_in" {{ request('referred_by') == 'walk_in' ? 'selected' : '' }}>Walk-in
                                </option>
                            </select>
                        </div>
                        <div class="flex gap-2">
                            <button type="submit"
                                class="px-4 py-2 bg-[#AC7E2C] text-white rounded-lg hover:bg-[#8C651F] transition-colors">
                                Search
                            </button>
