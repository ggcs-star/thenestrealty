    ...
    <div class="bg-white border border-gray-200 rounded-2xl shadow-sm p-6">
        ...
        <form action="{{ route('projects.update', $project->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" value="{{ $project->ex_unit }}"
                        class="mt-1 w-full px-4 py-2.5 rounded-lg border border-gray-200 bg-gray-100"
                        readonly>
            ...
            <div class="mt-6">
                ...
                <div class="mt-2 border border-dashed border-gray-300 rounded-lg p-4 text-center text-sm text-gray-400 hover:border-[#AC7E2C] transition">
